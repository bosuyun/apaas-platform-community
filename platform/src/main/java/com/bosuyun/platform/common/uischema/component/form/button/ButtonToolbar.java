package com.bosuyun.platform.common.uischema.component.form.button;
 ...
 */
public class ButtonToolbar extends FormItemBase {

    {
        this.setType(UiComponentType.BUTTON_TOOLBAR);
    }
}
