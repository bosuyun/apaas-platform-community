package com.bosuyun.platform.common.uischema.component.form.input;
 ...
 */
public class DateTimeRange extends FormItemBase {

    {
        this.setType(UiComponentType.DATETIME_RANGE);
    }
}
