package com.bosuyun.platform.common.uischema.component.form.layout;
 ...
 */
public class InputGroup extends FormItemBase {

    {
        this.setType(UiComponentType.INPUT_GROUP);
    }
}
