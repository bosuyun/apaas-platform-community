package com.bosuyun.platform.common.uischema.component.form.editor;
 ...
 */
public class DiffEditor extends FormItemBase {

    {
        this.setType(UiComponentType.DIFF_EDITOR);
    }
}
